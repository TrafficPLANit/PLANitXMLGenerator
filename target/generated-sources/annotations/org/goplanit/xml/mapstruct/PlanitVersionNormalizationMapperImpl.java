...
public class PlanitVersionNormalizationMapperImpl implements PlanitVersionNormalizationMapper {
    ...
    public XMLElementPLANit toModel(XMLElementPLANit source) {
        ...
        xMLElementPLANit.setServicenetwork( source.getServicenetwork() );
        xMLElementPLANit.setRoutedservices( source.getRoutedservices() );
    ...
    public XMLElementPLANit toModel(org.goplanit.xml.generated.v1.XMLElementPLANit source) {
        ...
        xMLElementPLANit.setMacroscopicdemand( toModel( source.getMacroscopicdemand() ) );
        xMLElementPLANit.setMacroscopiczoning( toModel( source.getMacroscopiczoning() ) );
        xMLElementPLANit.setServicenetwork( xMLElementServiceNetworkToXMLElementServiceNetwork( source.getServicenetwork() ) );
        xMLElementPLANit.setRoutedservices( xMLElementRoutedServicesToXMLElementRoutedServices( source.getRoutedservices() ) );
    ...
    public XMLElementMacroscopicZoning toModel(org.goplanit.xml.generated.v1.XMLElementMacroscopicZoning source) {
        ...
        xMLElementMacroscopicZoning.setIntermodal( macroscopicintermodalToMacroscopicintermodal( source.getIntermodal() ) );
    ...
    protected XMLElementServiceNetwork xMLElementServiceNetworkToXMLElementServiceNetwork(org.goplanit.xml.generated.v1.XMLElementServiceNetwork xMLElementServiceNetwork) {
        if ( xMLElementServiceNetwork == null ) {
            return null;
        }

        XMLElementServiceNetwork xMLElementServiceNetwork1 = objectFactory.createXMLElementServiceNetwork();

        xMLElementServiceNetwork1.setId( xMLElementServiceNetwork.getId() );
        xMLElementServiceNetwork1.setParentnetwork( xMLElementServiceNetwork.getParentnetwork() );
        if ( xMLElementServiceNetwork1.getServicenetworklayers() != null ) {
            List<XMLElementServiceNetworkLayer> list = xMLElementServiceNetworkLayerListToXMLElementServiceNetworkLayerList( xMLElementServiceNetwork.getServicenetworklayers() );
            if ( list != null ) {
                xMLElementServiceNetwork1.getServicenetworklayers().addAll( list );
            }
        }

        return xMLElementServiceNetwork1;
    }
    ...
    protected XMLElementRoutedServices xMLElementRoutedServicesToXMLElementRoutedServices(org.goplanit.xml.generated.v1.XMLElementRoutedServices xMLElementRoutedServices) {
        if ( xMLElementRoutedServices == null ) {
            return null;
        }

        XMLElementRoutedServices xMLElementRoutedServices1 = objectFactory.createXMLElementRoutedServices();

        xMLElementRoutedServices1.setId( xMLElementRoutedServices.getId() );
        xMLElementRoutedServices1.setExternalid( xMLElementRoutedServices.getExternalid() );
        xMLElementRoutedServices1.setServicelayers( servicelayersToServicelayers( xMLElementRoutedServices.getServicelayers() ) );

        return xMLElementRoutedServices1;
    }
    ...
    protected org.goplanit.xml.generated.v2.XMLElementTransferConnectoid xMLElementTransferConnectoidToXMLElementTransferConnectoid(XMLElementTransferConnectoid xMLElementTransferConnectoid) {
        if ( xMLElementTransferConnectoid == null ) {
            return null;
        }

        org.goplanit.xml.generated.v2.XMLElementTransferConnectoid xMLElementTransferConnectoid1 = objectFactory.createXMLElementTransferConnectoid();

        xMLElementTransferConnectoid1.setId( xMLElementTransferConnectoid.getId() );
        xMLElementTransferConnectoid1.setExternalid( xMLElementTransferConnectoid.getExternalid() );
        xMLElementTransferConnectoid1.setName( xMLElementTransferConnectoid.getName() );

        return xMLElementTransferConnectoid1;
    }

    protected List<org.goplanit.xml.generated.v2.XMLElementTransferConnectoid> xMLElementTransferConnectoidListToXMLElementTransferConnectoidList(List<XMLElementTransferConnectoid> list) {
        if ( list == null ) {
            return null;
        }

        List<org.goplanit.xml.generated.v2.XMLElementTransferConnectoid> list1 = new ArrayList<org.goplanit.xml.generated.v2.XMLElementTransferConnectoid>( list.size() );
        for ( XMLElementTransferConnectoid xMLElementTransferConnectoid : list ) {
            list1.add( xMLElementTransferConnectoidToXMLElementTransferConnectoid( xMLElementTransferConnectoid ) );
        }
    ...
    protected org.goplanit.xml.generated.v2.XMLElementTransferZoneAccess xMLElementTransferZoneAccessToXMLElementTransferZoneAccess(XMLElementTransferZoneAccess xMLElementTransferZoneAccess) {
        ...
        if ( xMLElementTransferZoneAccess1.getConnectoids() != null ) {
            List<org.goplanit.xml.generated.v2.XMLElementTransferConnectoid> list = xMLElementTransferConnectoidListToXMLElementTransferConnectoidList( xMLElementTransferZoneAccess.getConnectoids() );
            if ( list != null ) {
    ...
    protected Macroscopicintermodal macroscopicintermodalToMacroscopicintermodal(org.goplanit.xml.generated.v1.Macroscopicintermodal macroscopicintermodal) {
        if ( macroscopicintermodal == null ) {
            return null;
        }

        Macroscopicintermodal macroscopicintermodal1 = objectFactory.createMacroscopicintermodal();

        macroscopicintermodal1.setTransferzones( xMLElementTransferZonesToXMLElementTransferZones( macroscopicintermodal.getTransferzones() ) );
        macroscopicintermodal1.setTransferzoneaccess( xMLElementTransferZoneAccessToXMLElementTransferZoneAccess( macroscopicintermodal.getTransferzoneaccess() ) );
        macroscopicintermodal1.setTransferzonegroups( xMLElementTransferZoneGroupsToXMLElementTransferZoneGroups( macroscopicintermodal.getTransferzonegroups() ) );

        return macroscopicintermodal1;
    }
}
