    ...
    extends AbstractCoordinateSystemBaseType
{
     ...
     * This is why there is not a {@code set} method for the csID property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the csID property.
     */
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the usesAxis property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the usesAxis property.
     */
    public List<CoordinateSystemAxisRefType> getUsesAxis() {
        if (usesAxis == null) {
            usesAxis = new ArrayList<>();
        }
